...
package com.android.settings.processor;
...
//
public class Processor extends DashboardFragment implements
        Preference.OnPreferenceChangeListener {

    @Override
    public int getMetricsCategory() {
        return SettingsEnums.TOP_LEVEL_PROCESSOR; //frameworks/base/core/proto/android/app/settings_enums.proto
    }
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.processor_settings;
    }
